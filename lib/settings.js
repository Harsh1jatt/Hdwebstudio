...
export async function getSiteSettings() {
  ...
  try {
    ...
    return {
      ...
      homepage: {
        hero: {
          heading1: "We Build Websites That",
          heading2: "Grow Businesses.",
          description: "Professional website development, local SEO, and digital growth solutions for businesses in Ludhiana, Punjab and across India. We help you get discovered, build trust, and get contacted.",
          ctaText: "Get a Free Digital Audit",
          ctaLink: "/contact",
...
/**
 * Get service page shared data (techStack, process, etc.) from settings.
 */
export async function getServicePageData() {
  const settings = await getSiteSettings();
  return settings.servicePage || {
    techStack: [],
    process: [],
    whyChooseUs: [],
    industries: [],
