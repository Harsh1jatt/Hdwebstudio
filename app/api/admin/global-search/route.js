...
export async function GET(req) {
  try {
    ...
    const results = [
      ...
      ...projects.map((pr) => ({ id: pr._id.toString(), type: "project", title: pr.title, subtitle: `Client: ${pr.client || "Confidential"}`, url: `/admin/projects/${pr._id}`, publicUrl: `/portfolio/${pr.slug}`, status: pr.published ? "published" : "draft" })),
