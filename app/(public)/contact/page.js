      ...
      <div className="relative max-w-7xl mx-auto px-6 pb-20">
        ...
        >
          ...
          <form className="grid grid-cols-1 gap-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="contact-message" className="mb-1.5 block text-sm font-semibold text-slate-700">What do you need? <span className="text-red-500">*</span></label>
              <textarea
                id="contact-message"
                name="message"
                placeholder="Tell us about your project — what kind of website or digital solution you need, and any specific requirements."
                rows="5"
                className="w-full px-5 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-sm sm:text-base"
                required
              ></textarea>
