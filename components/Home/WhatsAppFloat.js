...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <AnimatePresenceCompat show={showTooltip}>
      ...
      <a
        ...
        className="relative w-14 h-14 bg-green-500 hover:bg-green-400 rounded-full flex items-center justify-center shadow-xl shadow-green-500/40 transition-colors duration-200"
      >
        {/* Pulse Ring */}
...
// Minimal show/hide wrapper (avoids needing AnimatePresence import in this file)
function AnimatePresenceCompat({ show, children }) {
  if (!show) return null;
  return (
