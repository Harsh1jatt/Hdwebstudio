...
export default function PricingForm({
  ...
  const [form, setForm] = useState({
    ...
    ...initialData,
    features:
      Array.isArray(initialData.features) && initialData.features.length
  ...
  function handleSubmit(e) {
    ...
    const payload = {
      ...
      highlighted: form.highlighted === true,
      published: form.published === true,

      note: form.note?.trim() || "",

      ctaText: form.ctaText?.trim() || "Get Started",
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Section
        ...
        description="Core plan identity."
      >
      ...
      <Section
        title="Pricing"
        description="Price and billing details."
      >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              updateField("billingPeriod", e.target.value)
            }
      ...
      <Section
        ...
        description="Button text and link."
      >
        <div className="grid gap-4 md:grid-cols-2">
          <AdminInput
            id="ctaText"
      ...
      <Section
        title="Publishing"
        description="Control visibility and sort order."
      >
        <div className="grid gap-4 md:grid-cols-2">
          <AdminInput
            id="order"
